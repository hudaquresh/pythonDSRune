"""Construct a maze that we solve and explore"""
...
class Maze(): 
	def __init__(self, mazeFileName):  
		'Initializes the maze based on a data file and finds the start for the turtle.' 
		rowsInMaze = 0 
		columnsInMaze = 0 
		self.mazelist = []
	...
	def updatePosition(self, row, col, val=None): 
		'Updates the internal representation of the maze and changes position of the turtle' 
		if val: 
